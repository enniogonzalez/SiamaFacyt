...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Formato de Mantenimiento Correctivo Planificado", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Formato de Mantenimiento Correctivo Planificado');
$pdf->SetSubject('Formato de Mantenimiento Correctivo Planificado');
...
$tbl = "
    <table cellspacing=\"0\" cellpadding=\"1\" style=\"border: 1px solid black;\">
        <tr >
            ...
            <td style=\"width:20%\"><strong>Estatus:</strong></td>
            <td style=\"width:15%\">" . $datos['estatus'] . "</td>
        </tr>
        <tr >
...
foreach ($datos['Piezas'] as $elemento) {
        $tbl .= "<table><tr>
                        ...
                        <td style=\"width:30%\">" . $elemento['fal_nom'] . "</td>
                        <td style=\"width:20%\">" . $elemento['observaciones'] . "</td>
                    </tr></table><hr>";
}

$tbl .= "<table><tr><td><strong>" . count($datos['Piezas']) . " Piezas Dañadas</strong></td></tr></table>";
