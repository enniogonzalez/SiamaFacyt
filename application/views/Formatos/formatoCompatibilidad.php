...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Formato de Compatibilidad", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Formato de Compatibilidad');
$pdf->SetSubject('Formato de Compatibilidad');
...
$pdf->SetFont('helvetica', '', 10);
$tbl =" <br>
        <h2>Tipo de Piezas Agregadas</h2>
        <table>
            <thead>
                <tr style=\"font-weight: bold; \">
                    <th style=\"width:60%\">Tipo de Pieza</th>
...
foreach ($datos['Agregados'] as $elemento) {
        $tbl .= "<table><tr>
                        <td style=\"width:60%\">" . $elemento['tpi_nom'] . "</td>
                        <td style=\"width:40%\">" . $elemento['observaciones'] . "</td>
                    </tr></table><hr>";
}

$tbl .= "<table><tr><td><strong>" . count($datos['Agregados']) . " Tipo de Piezas Agregadas</strong></td></tr></table>";
...
$tbl .= "<table><tr><td><strong>" . count($datos['Quitados']) . " Tipo de Piezas Quitadas</strong></td></tr></table>";
...
$pdf->Output('Formato de Compatibilidad' . $datos['documento']  . '.pdf', 'I');
