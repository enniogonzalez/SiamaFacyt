...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Formato de Herramienta", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Formato de Herramienta');
$pdf->SetSubject('Formato de Herramienta');
...
$pdf->Output('FormatoHerramienta' . substr("0000000000" . trim($datos['her_id'] ),-10)  . '.pdf', 'I');
