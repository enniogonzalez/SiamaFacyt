...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Formato de Partida", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Formato de Partida');
$pdf->SetSubject('Formato de Partida');
...
$pdf->Output('formatoPartida' . substr("0000000000" . trim($datos['par_id'] ),-10)  . '.pdf', 'I');
