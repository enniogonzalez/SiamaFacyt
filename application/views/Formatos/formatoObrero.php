...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Formato de Obrero", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Formato de Obrero');
$pdf->SetSubject('Formato de Obrero');
...
$tbl = "
    <table cellspacing=\"0\" cellpadding=\"1\" style=\"border: 1px solid black;\">
        <tr>
            <td style=\"width:15%;\"> <strong>Cédula:</strong></td>
            <td style=\"width:35%;\">" . $datos['cedula'] . "</td>
...
$pdf->Output('formatoObrero' . substr("0000000000" . trim($datos['obr_id'] ),-10)  . '.pdf', 'I');
