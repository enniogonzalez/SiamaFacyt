...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Formato de Tipo de Pieza", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Formato de Tipo de Pieza');
$pdf->SetSubject('Formato de Tipo de Pieza');
...
$pdf->Output('formatoTipoPieza' . substr("0000000000" . trim($datos['tpi_id'] ),-10)  . '.pdf', 'I');
