...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Formato de Lista Desplegable", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Formato de Lista Desplegable');
$pdf->SetSubject('Formato de Lista Desplegable');
...
$pdf->Output('formatoListaDesplegable' . $datos['ld_id']  . '.pdf', 'I');
