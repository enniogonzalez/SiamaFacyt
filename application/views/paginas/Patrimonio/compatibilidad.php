<div class="container">
    <div class="row">
        <div class="col-lg-9" style="padding: 0px;">
            <h2><span class="fa fa-object-group"></span> Compatibilidad</h2>  
        </div>
    </div>
</div>
...
<div class="container">
    <div class="formulario-siama">
        ...
        <form class ="formulario-desactivado" id="FormularioActual" method="POST" action = "<?=site_url('/compatibilidad/guardar')?>">
            ...
            <div class="form-group row">
                <label for="DocumentoCompatibilidad" class="col-lg-3 col-form-label">Documento:</label>
                <div class="col-lg-9">
                    <input readonly disabled type="text" maxlength="10"
                        class="form-control texto documento" id="DocumentoCompatibilidad" value="<?=$documento?>">
                </div>
            </div>

            <div class="form-group row">
                <label for="EstatusCompatibilidad" class="col-lg-3 col-form-label">Estatus:</label>
                <div class="col-lg-9">
                    <input readonly disabled type="text" maxlength="100"
                        class="form-control texto estatus" id="EstatusCompatibilidad" value="<?=$estatus?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <div style="width:86%;float:left;">
                        <div style="display:none;" id="idBieCompatibilidad"><?=$bie_id?></div>
                        <input readonly disabled type="text"
                            class="form-control obligatorio texto buscador" id="nomBieCompatibilidad" value="<?=$bie_nom?>">
                        <div class="invalid-feedback">Campo Obligatorio</div>
                    </div>
                    <div style="width:14%;float:right;padding:10px;">
                        <span title="Buscar Bien" class="fa fa-search BuscarBienCompatibilidad" style="cursor: pointer;float:left;"></span>
                        <span title="Borrar Bien" class="fa fa-trash-o BorrarBienCompatibilidad" style="cursor: pointer;float:right;"></span>
                    </div>
                </div>
            </div>

            <div class="form-group row">
                <label for="ObservacionCompatibilidad" class="col-lg-3 col-form-label">Observaci&oacute;n:</label>
                <div class="col-lg-9">
                    <textarea  readonly disabled class="form-control texto" rows="3"
                    style = "resize:vertical;" id="ObservacionCompatibilidad"><?=$observaciones?></textarea>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table id="TablaAgregarTipos" class="table table-hover tabla-siama tabla-siama-desactivada">
            ...
            <h3>
                Quitar Tipo de Pieza
            </h3>
            <div class="table-responsive">
                <table id="TablaQuitarTipos" class="table table-hover tabla-siama tabla-siama-desactivada">
                    <thead class="head-table-siama" style="font-size:11px;">
                        <tr>
                            <th style="width:90%;">Pieza</th>
                            <th style="width:5%;">
        ...
        <div style="display:none;" id ="ControladorActual"><?=site_url('/compatibilidad')?></div>
