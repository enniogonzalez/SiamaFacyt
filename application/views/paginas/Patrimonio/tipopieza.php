<div class="container">
    <div class="row">
        <div class="col-lg-9" style="padding: 0px;">
            <h2><span class="fa fa-bandcamp"></span> Tipo de Pieza</h2> 
        </div>
    </div>
</div>
...
<div class="container">
    <div class="formulario-siama">
        ...
        <form class ="formulario-desactivado" id="FormularioActual" method="POST" action = "<?=site_url('/tipopieza/guardar')?>">
            ...
            <div class="form-group row">
                <label for="nombreTipoPieza" class="col-md-3 col-form-label">Nombre:</label>
                <div class="col-md-9">
                    <input maxlength="100" readonly disabled type="text" 
                    class="form-control obligatorio texto" id="nombreTipoPieza" value="<?=$nombre?> ">
        ...
        <div style="display:none;" id ="ControladorActual"><?=site_url('/tipopieza')?></div>
