<div class="container">
    <div class="row">
        <div class="col-lg-9" style="padding: 0px;">
            <h2><span class="fa fa-exclamation-triangle"></span> Fallas</h2> 
        </div>
    </div>
</div>
...
<div class="container">
    <div class="formulario-siama">
        ...
        <form class ="formulario-desactivado" id="FormularioActual" method="POST" action = "<?=site_url('/fallas/guardar')?>">
            ...
            <div class="form-group row">
                <label for="nombreFalla" class="col-md-3 col-form-label">Nombre:</label>
                <div class="col-md-9">
                    <input maxlength="255" readonly disabled type="text" 
                    class="form-control obligatorio texto" id="nombreFalla" value="<?=$nombre?>">
                    <div class="invalid-feedback">Campo Obligatorio</div>
                </div>
            </div>
            
            <div class="form-group row">
                <label for="tipoFalla" class="col-md-3 col-form-label">Tipo:</label>
                <div class="col-md-9">
                    <input maxlength="100" readonly disabled type="text" 
                    class="form-control obligatorio texto" id="tipoFalla" value="<?=$nombre?> ">
                    <div class="invalid-feedback">Campo Obligatorio</div>
                </div>
            </div>
        ...
        <div style="display:none;" id ="ControladorActual"><?=site_url('/fallas')?></div>
