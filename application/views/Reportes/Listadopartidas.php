...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Listado de Partidas", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Listado de Partidas');
$pdf->SetSubject('Listado de Partidas');
...
foreach ($datos as $elemento) {
        $tbl .= "<table><tr>
                        <td style=\"width:30%\">" . $elemento['codigo'] . "</td>
                        <td style=\"width:40%\">" . $elemento['nombre'] . "</td>
                        <td style=\"width:30%\">" . $elemento['observaciones'] . "</td>
                    </tr></table><hr>";
}

$tbl .= "<table><tr><td><strong>" . count($datos) . " Partidas</strong></td></tr></table>";
...
$pdf->Output('ListadoPartidas.pdf', 'I');
