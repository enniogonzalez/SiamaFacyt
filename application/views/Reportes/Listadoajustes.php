...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Listado de Ajustes", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Listado de Ajustes');
$pdf->SetSubject('Listado de Ajustes');
...
$tbl .= "<table><tr><td><strong>" . count($datos) . " Ajustes</strong></td></tr></table>";
...
$pdf->Output('ListadoAjustes.pdf', 'I');
