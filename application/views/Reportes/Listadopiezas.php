...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Listado de Piezas", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Listado de Piezas');
$pdf->SetSubject('Listado de Piezas');
...
foreach ($datos as $elemento) {
        $tbl .= "<table cellpadding=\"2\"><tr>
                        <td style=\"width:35%\">" . $elemento['nombre'] . "</td>
                        <td style=\"width:9%\">" . $elemento['estatus'] . "</td>
                        <td style=\"width:12%\">" . $elemento['inv_uc'] . "</td>
                        <td style=\"width:12%\">" . $elemento['nomtpi'] . "</td>
                        <td style=\"width:12%\">" . $elemento['nommar'] . "</td>
                        <td style=\"width:20%\">" . $elemento['nombie'] . "</td>
                    </tr></table><hr>";
}

$tbl .= "<table><tr><td><strong>" . count($datos) . " Piezas</strong></td></tr></table>";
...
$pdf->Output('ListadoPiezas.pdf', 'I');
