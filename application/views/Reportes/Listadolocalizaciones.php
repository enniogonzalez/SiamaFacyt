...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Listado de Localizaciones", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Listado de Localizaciones');
$pdf->SetSubject('Listado de Localizaciones');
        ...
        <table>
            <thead>
                <tr style=\"font-weight: bold; \">
                    ...
                    <th style=\"width:40%\">Ubicaci&oacute;n</th>
...
foreach ($datos as $elemento) {
        $tbl .= "<table><tr>
                        <td style=\"width:40%\">" . $elemento['nombre'] . "</td>
                        <td style=\"width:40%\">" . $elemento['ubicacion'] . "</td>
                        <td style=\"width:20%\">" . $elemento['tipo'] . "</td>
                    </tr></table><hr>";
}

$tbl .= "<table><tr><td><strong>" . count($datos) . " Localizaciones</strong></td></tr></table>";
...
$pdf->Output('ListadoLocalizaciones.pdf', 'I');
