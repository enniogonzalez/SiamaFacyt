...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Listado de Proveedores", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
        ...
        <table>
            <thead>
                <tr style=\"font-weight: bold; \">
                    <th style=\"width:20%\">R.I.F</th>
                    <th style=\"width:60%\">Raz&oacute;n Social</th>
                    <th style=\"width:20%\">RNC</th>
                </tr>
            </thead>
        </table><hr>";
...
foreach ($datos as $elemento) {
        $tbl .= "<table><tr>
                        <td style=\"width:20%\">" . $elemento['rif'] . "</td>
                        <td style=\"width:60%\">" . $elemento['raz_soc'] . "</td>
                        <td style=\"width:20%\">" . $elemento['reg_nac_con'] . "</td>
                    </tr></table><hr>";
}

$tbl .= "<table><tr><td><strong>" . count($datos) . " Proveedores</strong></td></tr></table>";
...
$pdf->Output('ListadoProveedores.pdf', 'I');
