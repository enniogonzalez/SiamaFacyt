...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(23);
        $this->Cell(200, 10, "Listado de Compatibilidad", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetY(28);
...
$pdf->SetTitle('Listado de Compatibilidad');
$pdf->SetSubject('Listado de Compatibilidad');
...
foreach ($datos as $elemento) {
        $tbl .= "<table><tr>
                        ...
                        <td style=\"width:20%\">" . $elemento['estatus'] . "</td>
                        <td style=\"width:15%\">" . $elemento['fecha'] . "</td>
                        <td style=\"width:40%\">" . $elemento['nombre'] . "</td>
                    </tr></table><hr>";
}

$tbl .= "<table><tr><td><strong>" . count($datos) . " Compatibilidad</strong></td></tr></table>";
...
$pdf->Output('ListadoCompatibilidad.pdf', 'I');
