<?php
    ...
    class Correctivo extends CI_Controller{
        ...
        public function busqueda(){
            ...
            $respuesta = $this->FormatearBusqueda($this->correctivo_model->Busqueda($data));
        ...
        public function busquedaRealizado(){
            ...
            $respuesta = $this->FormatearBusqueda($this->correctivo_model->BusquedaRealizado($data));
        ...
        public function guardar(){
            ...
            $parametros = array(
                ...
                "cpl_id"        => $this->input->post("Doc_Pla"),
                "Bie_Pla"       => $this->input->post("Bie_Pla"),
        ...
        public function reversar(){
            ...
            if($this->correctivo_model->PuedeReversar($this->input->post("id"))){
        ...
        public function view(){
            ...
            $listaBusquedaCorPla= $this->listasdesplegables_model->Obtener('','COB-CORPLA');
            ...
            $data['listaBusquedaCorPla'] = $this->liblistasdesplegables->FormatearListaDesplegable($listaBusquedaCorPla);
